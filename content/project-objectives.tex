\chapter{Objetivos del proyecto}
	...
	\section{Planificación}
		...
		\subsection{Plan de trabajo}
			...
			\begin{figure}[!htp]
				\centering
				\includegraphics[page=6, scale=.45, angle=90]{fig/Plan6}
				\caption{Diagrama del plan de trabajo 6}
			\end{figure}

			\begin{figure}[!htp]
				\centering
				\includegraphics[page=7, scale=.45, angle=90]{fig/Plan7}
				\caption{Diagrama del plan de trabajo 7}
			\end{figure}

			\begin{figure}[!htp]
				\centering
				\includegraphics[page=8, scale=.45, angle=90]{fig/Plan8}
